...
"""
DATA_INGESTION_COLLECTION_NAME: str = "CreditRiskData"
DATA_INGESTION_DATABASE_NAME: str = "MuhammadHilmy"
...
DATA_TRANSFORMATION_TRANSFORMED_DATA_OBJECT_DIR: str = "transformed_object"
